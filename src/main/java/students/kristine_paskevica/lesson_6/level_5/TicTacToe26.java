...
class TicTacToe26 {
    ...
    public boolean fromLeftCorner(int[][] field, int playerToCheck) { //augšējais kreisais stūris
        int count = 0;
        int j = 0;
        for (int[] ints : field) {
    ...
    public boolean fromRightCorner(int[][] field, int playerToCheck) { //labais augšējais stūris
        int count = 0;
