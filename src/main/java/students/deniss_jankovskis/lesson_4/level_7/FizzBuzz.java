...
class FizzBuzz {
    ...
    public String detect(int number) {
        ...
        if (number % 3 == 0 && number % 5 == 0) { //если переданное число делится на три и на пять возвращайте "FizzBuzz"
            return "FizzBuzz";
        } else if (number % 3 == 0) { //если переданное число делится на три возвращайте "Fizz"
            return "Fizz";
