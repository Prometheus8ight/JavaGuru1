...
public class FindBookByLetterTest {
    ...
    public void findBookByLetterTest1() {
        ...
        Book[] realResult = bookReaderImpl.findBooksByTitle("T");
        checkTestResult(realResult, new Book[]{book3}, "Find Book By Letter Test 1");
    }
    ...
    public void findBookByLetterTest2() {
        ...
        bookReaderImpl.addBook(book3);
        bookReaderImpl.addBook(book4);
        Book[] realResult = bookReaderImpl.findBooksByTitle("AB");
        checkTestResult(realResult, new Book[]{book1}, "Find Book By Letter Test 2");
    }
