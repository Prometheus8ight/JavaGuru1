package students.vitaly_porsev.lesson_6.level_7.task_33;
...
class TicTacToe {
    ...
    public void randomAIMove(int[][] field, int player1) {
    ...
    private boolean drawField(int[][] field) {
        boolean num = true;
        for (int[] ints : field) {
            for (int anInt : ints) {
                if (anInt == -1) {
