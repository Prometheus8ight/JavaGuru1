...
class ArrayServiceTest {
    public static void main(String[] args) {
        ...
        System.out.println("Sort all test: ");
        arrayServiceTest.sortNumbers(new int[]{4, 3, 7});
    ...
    public void replacementAllNumbers1(int[] arr, int numbersToReplace, int number) {
        ...
        check2(result, 2, "Replacement Asll test - 1");
    }
    ...
    public void check4(String result, String expected, String testName) {
