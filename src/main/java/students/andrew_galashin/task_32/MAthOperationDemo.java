...
class MAthOperationDemo {
    ...
    public static void main(String[] args) {
        ...
        Argument ar2 = new Argument(5);
        MathOperation subtraction1 = new Subtraction(ar1, ar2);

        Argument ar3 = new Argument(20);
        Argument ar4 = new Argument(5);
        MathOperation division = new Division(ar3, ar4);

        MathOperation multiplication = new Multiplication(subtraction1, division);
        System.out.println("(10 - 5) * (20 / 5) = " + multiplication.calculate());
    }
