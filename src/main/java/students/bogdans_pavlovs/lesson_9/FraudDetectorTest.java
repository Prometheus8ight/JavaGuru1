...
class FraudDetectorTest {
    ...
    void pokemonTest(){
        ...
        Transaction transaction = new Transaction(new Trader("Pokemon", "Riga", "Latvia"), 600);
    ...
    void notFromSydneyTest(){
        ...
        Transaction transaction = new Transaction(new Trader("Definitely Not Pokemon", "Sydney", "Australia"), 999999);
        FraudDetector fraudDetector = new FraudDetector(transaction);
    ...
    void germanyRegulationsTest(){
        ...
        Transaction transaction = new Transaction(new Trader("Hans","Berlin", "Germany"), 1001);
        FraudDetector fraudDetector = new FraudDetector(transaction);
    ...
    void notFromJamaicaTest(){
        ...
        Transaction transaction = new Transaction(new Trader("Definitely Not Pokemon","Kingston", "Jamaica"), 999999);
        FraudDetector fraudDetector = new FraudDetector(transaction);
