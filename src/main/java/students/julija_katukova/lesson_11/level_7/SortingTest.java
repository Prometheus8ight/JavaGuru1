...
class SortingTest {
    ...
    public static void main(String[] args) {
        SortingTest pageCriteriaTest = new SortingTest();
    ...
    private void test1() {
        ...
        pageCriteria.setSortedByAuthors(true);
        realResult = pageCriteria.getBooksForDisplay(bookDatabase.getBooks());
        expectedResult = new ArrayList<>();
        expectedResult.add(book9);
        expectedResult.add(book12);
        ...
        expectedResult.add(book11);
        expectedResult.add(book6);
        check(realResult, expectedResult, "Test 2-0");
        ...
        expectedResult.add(book8);
        expectedResult.add(book4);
        check(realResult, expectedResult, "Test 2-1");

        pageCriteria.setPageSize(2);
        pageCriteria.setPageNumber(5);
        realResult = pageCriteria.getBooksForDisplay(bookDatabase.getBooks());
        expectedResult = new ArrayList<>();
        expectedResult.add(book7);
        expectedResult.add(book1);
        check(realResult, expectedResult, "Test 2-2");

        pageCriteria.setPageSize(1);
        pageCriteria.setPageNumber(11);
        realResult = pageCriteria.getBooksForDisplay(bookDatabase.getBooks());
        expectedResult = new ArrayList<>();
        expectedResult.add(book11);
        check(realResult, expectedResult, "Test 2-3");

        pageCriteria.setPageSize(4);
        pageCriteria.setPageNumber(1);
        realResult = pageCriteria.getBooksForDisplay(bookDatabase.getBooks());
        expectedResult = new ArrayList<>();
        expectedResult.add(book9);
        ...
        expectedResult.add(book3);
        expectedResult.add(book2);
        check(realResult, expectedResult, "Test 2-4");
    }
