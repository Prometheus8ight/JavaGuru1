...
class DeleteBooksByTitleTest {

    public static void main(String[] args) {
        DeleteBooksByTitleTest findBooksByAuthorTest = new DeleteBooksByTitleTest();
    ...
    private void test1() {
        ...
        bookDatabase.deleteByTitle("In Search of Lost Time");
    ...
    private void test2() {
        ...
        bookDatabase.deleteByTitle("You");
        List<Book> realResult = bookDatabase.getBooks();
        List<Book> expectedResult = new ArrayList<>();
