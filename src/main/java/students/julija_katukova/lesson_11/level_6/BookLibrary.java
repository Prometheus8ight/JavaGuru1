...
class BookLibrary {
    ...
    public BookLibrary() {
        ...
        menuNumberToActionMap.put(6, new DeleteBookUIAction(bookDatabase));
        ...
        menuNumberToActionMap.put(10, new FindBySearchCriteriaUIAction(bookDatabase));
        ...
        menuNumberToActionMap.put(15, new GetAuthorsToBookMapUIAction(bookDatabase));
