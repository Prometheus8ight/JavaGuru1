package students.darja_scavrovica.lesson_4.level_6.task_25;
 ...
 public void testInvisible(int wavelength) {
  ...
  public void check (String result,String expectedResult, String testName ){
   if(result.equals(expectedResult)){
    System.out.println("LightColorDetector test "+ testName + " = TRUE");
   }else
    System.out.println("LightColorDetector test  = FALSE");
  }
 }