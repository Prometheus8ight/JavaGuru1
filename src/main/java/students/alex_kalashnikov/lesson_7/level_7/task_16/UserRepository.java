...
class UserRepository {
    ...
    String[][] createArray(int expectedClientAmount, int amountOfClientParameters) {
    ...
    void addUser(String[][] arr, String firstName, String surname, String idNumber) {
        ...
        if (userNumber >= arr.length) {
            ...
            arr[userNumber][0] = UserEntity.setFirstName(firstName);
            arr[userNumber][1] = UserEntity.setSurname(surname);
            arr[userNumber][2] = UserEntity.setIdNumber(idNumber);
        }
    }
    ...
    void editUser(String[][] arr, String currentIdNumber, String newFirstName, String newSurname, String newIdNumber) {
        ...
        arr[userNumber][0] = UserEntity.setFirstName(newFirstName);
        arr[userNumber][1] = UserEntity.setSurname(newSurname);
        arr[userNumber][2] = UserEntity.setIdNumber(newIdNumber);
    }
