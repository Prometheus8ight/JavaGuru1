...
class StockDemoTest {
    ...
    public void maxPriceTest() {
        ...
        int realResult = stockTest.setMaxPrice(stockTest.maxPrice);
    ...
    public void maxPriceTest1() {
        ...
        Stock stockTest = new Stock("GOOG",999);
        stockTest.maxPrice = stockTest.currentPrice;
        stockTest.currentPrice = stockTest.updatePrice(); {stockTest.currentPrice = 1;}
        stockTest.maxPrice = stockTest.setMaxPrice(stockTest.currentPrice);
    ...
    public void maxPriceTest2() {
        ...
        Stock stockTest = new Stock("GOOG",999);
        stockTest.maxPrice = stockTest.currentPrice;
        stockTest.currentPrice = stockTest.updatePrice(); {stockTest.currentPrice = 2;}
        stockTest.maxPrice = stockTest.setMaxPrice(stockTest.currentPrice);
    ...
    public void maxPriceTest4() {
        ...
        stockTest.maxPrice = stockTest.currentPrice;
        stockTest.currentPrice = stockTest.updatePrice(); {stockTest.currentPrice = 27;}
        stockTest.maxPrice = stockTest.setMaxPrice(stockTest.currentPrice);
        int realResult = stockTest.maxPrice;
        if (realResult == expectedResult) {
