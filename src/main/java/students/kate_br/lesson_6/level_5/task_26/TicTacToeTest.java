...
class TicTacToeTest {
    ...
    public static void main(String[] args) {
        ...
        test.isWinTest(new int[][]{{1, 1, 1}, {1, 0, -1}, {-1, 0, 0}});
        test.isDrawTest(new int[][]{{1, 0, 1}, {0, 0, 1}, {0, 1, 0}});
    }
    ...
    public void isWinTest(int[][] field) {
        ...
        checkTestResult(realResult, false, "Is win test");
    }
    ...
    public void isDrawTest(int[][] field) {
        ...
        TicTacToe ticTacToe = new TicTacToe();
        boolean realResult = ticTacToe.isDrawPosition(field);
        checkTestResult(realResult, true, "Is draw test");
